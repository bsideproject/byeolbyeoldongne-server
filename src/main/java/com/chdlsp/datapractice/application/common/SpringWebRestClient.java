package com.chdlsp.datapractice.application.common;

import com.chdlsp.datapractice.application.common.client.AdapterRestClient;
...
//
        ...
        log.debug(String.format("[ResTemplateExchange] to = [%s], method = [%s]", httpUrl,
                HttpMethod.valueOf(httpMethod)));
        log.debug(String
                .format("[ResTemplateExchange] headers = %s, body = [%s] ", requestEntity.getHeaders(),
                        requestEntity.getBody()));
        ResponseEntity responseEntity = restTemplate
                .exchange(httpUrl, HttpMethod.valueOf(httpMethod), requestEntity, clazz);
        HttpHeaders responseHeaders = responseEntity.getHeaders();
        requestBuilder.setRespHeaders(responseHeaders);
        log.debug("[ResTemplateResult] status = {{}}, body = {{}}", responseEntity.getStatusCode(),
